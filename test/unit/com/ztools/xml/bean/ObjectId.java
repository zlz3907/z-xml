...
public class ObjectId implements Comparable<ObjectId> , java.io.Serializable {
     ...
     * @return the new id
     */
    public static ObjectId get(int type){
      dataType=type;
        return new ObjectId();
    }
    
    public static String getObjectId(int type){
      dataType=type;
    ...
    public String toStringMongod(){
        ...
        return convertType(buf.toString());
       // return buf.toString();
    }
    
    public String convertType(String oid){
      if(dataType!=0){
        String f = oid.substring(0,8);
        String e=oid.substring(10,oid.length());
        return f+dataType+e;
      }
      return oid;
    }
